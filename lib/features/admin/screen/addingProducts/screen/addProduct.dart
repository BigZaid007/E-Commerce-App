            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  ProductInputField(
                      productNameController, 'Product Name', context),
                  const SizedBox(
                    height: 15,
                  ),
                  ProductInputField(
                      productDesController, 'Product Description', context,
                      maxLines: 6),
                  const SizedBox(
                    height: 15,
                  ),
                  ProductInputField(
                      productPriceController, 'Product Price', context),
                  const SizedBox(
                    height: 15,
                  ),
                  ProductInputField(
                      productQuantityController, 'Product Quantity', context),
                  SizedBox(height: 10,),
                  SizedBox(
